...
def compute_each_part_acc(label_pred):
    labels = ['Addition', 'Appetit', 'Aspirateur', 'Attirer', 'Baguette', 'Ballon', 'Beau', 'Bonne', 'Calendrier', 'Cameleon',
              'Carnaval', 'Ce', 'Celle', 'Cette', 'Cheval', 'Chiffon', 'Coeur', 'Concombre', 'Crocodile', 'De',
              'Decider', 'Dentifrice', 'Des', 'Dessin', 'Doudou', 'Ecole', 'Escalader', 'Fillette', 'Hache', 'Huitre',
              'Joli', 'Jouet', 'Joyeux', 'La', 'Le', 'Les', 'Lundi', 'Ma', 'Maison', 'Maman', 'Manoir', 'Mes', 'Mon',
              'Moto', 'Multicolore', 'Musique', 'Neige', 'Panier', 'Parking', 'Pas', 'Pomme', 'Pyjama', 'Requin', 'Robe',
              'Ruisseau', 'Sa', 'Sapin', 'Serpent', 'Ses', 'Son', 'Ta', 'Tentation', 'Terminer', 'Tes', 'Ton', 'Trampoline',
              'Ventilateur', 'Voiture', 'Xylophone', 'Zebre']
    ambigious_labels = ['Ce', 'Celle', 'De', 'Des', 'La', 'Le', 'Les', 'Ma', 'Mes', 'Mon', 'Pas', 'Sa', 'Ses', 'Son',
                        'Ta', 'Tes', 'Ton']
